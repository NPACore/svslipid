function lcm_batch(projectName)
% function lcm_batch(projectName)
%
% SVS processing
%
...
if 0
    ...
    % Prisma sequence naming
    if strcmp(projectName,'NIN-BOB')
         svs_scans = {...
           'svs_se_30_12x12x12_DistTibia',...
           'svs_se_30_L4',...
         };
    end
end
                            ...
                            for j=1:nlist
                               ...
                               if ~isempty(IND)
                                   ...
                                   for k=3:nSVSdicom
                                       ...
                                       % run lcmodel
                                       strpat = {'.raw','.control','.csv','.ps','.coord','.pdf'};
                                       ...
                                       if TF==true
                                           % Liver
                                           cprintf('Blue','............%s\n', name_);
                                           svs_press_lipid_lcm(folder_, name_, 'liver-11', false);
                                           continue;
                                       else
                                           % Bone
                                           cprintf('White','............%s\n', name_);
                                           %svs_press_bone_lcm(folder_, name_, false);
                                           svs_press_lipid_lcm(folder_, name_, 'lipid-8', false);
                                       end
